...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'ar25_nas@kelvinkwok.met',
  ...
  title: "Grandeur - Anderson Road Quarry Site R2-5 (Transmittal Out)",

  // The folder that you are to share publicly with onedrive-vercel-index. Use '/' if you want to share your root folder.
  baseDirectory: '/AR25/02A OUTGOING SUBMISSION/2A.4 Transmittal Out',
